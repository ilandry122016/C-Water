...
query (void)
{
  ...
  gimp_plugin_menu_register ("plug-in-verify-watermark",
			     "<Image>/Filters/Misc");
}

static void
verify_watermark(GimpDrawable *drawable, guchar *pixels_to_change, gint lower_limit_x, gint lower_limit_y, gint upper_limit_x, gint upper_limit_y, gint channels)
{
  gint         i, j, k;
